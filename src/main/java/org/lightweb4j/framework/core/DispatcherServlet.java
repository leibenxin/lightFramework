...
import org.lightweb4j.framework.bean.Data;
...
import org.lightweb4j.framework.helper.ConfigHelper;
import org.lightweb4j.framework.helper.ControllerHelper;
import org.lightweb4j.framework.utils.*;
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (handler != null){
            ...
            if (result instanceof View){
                ...
                if (model != null){
                    resp.setContentType("applection/json");
